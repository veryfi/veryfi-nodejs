 ...
 * @param {Object} kwargs Additional request parameters (q, order_by, external_id, device_id, device_user_uuid, status, tag, owner, created__/updated__/date__ gt/lt/gte/lte, track_total_results, detailed)
...
Client.prototype.get_documents = async function (
    ...
    let documents = await this._request("GET", endpoint_name, {}, query, false);
